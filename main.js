...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (currentPage === 'profile.html') {
        ...
        fetch(`https://github-io-dqp7.onrender.com/api/user-status/${user.civilnumber}`)
            .then(res => res.json())
            .then(data => {
                if (data.success) {
        ...
        if (user.status === 'pending' || user.status === 'rejected') {
            ...
            if (user.status === 'rejected') {
                document.getElementById('resubmit-button').addEventListener('click', async () => {
                    await fetch(`https://github-io-dqp7.onrender.com/api/user/${user.civilnumber}`, { method: 'DELETE' });
            ...
            if (fullnameElement && civilnumberElement && avatarPreview) {
                ...
                avatarInput?.addEventListener('change', function () {
                    ...
                    reader.onloadend = function () {
                        ...
                        fetch('https://github-io-dqp7.onrender.com/api/update-avatar', {
                            method: 'POST',
    ...
    if (currentPage === 'registration.html') {
        ...
        if (registerForm) {
            registerForm.addEventListener('submit', function (e) {
                ...
                fetch('https://github-io-dqp7.onrender.com/api/register', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
    ...
    if (currentPage === 'vote.html') {
        ...
        form?.addEventListener('submit', async (e) => {
            ...
            const res = await fetch('https://github-io-dqp7.onrender.com/api/vote', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
